<?php return array(
    ...
    'sv' => array(
        'snippet_proposal_title' => '<snippet_undefined><snippet_keyword>%1%</snippet_keyword> har saknade steg. Definera dem med dessa kodsnuttar:</snippet_undefined>',
        'snippet_missing_title'  => '<snippet_undefined>Kodsnuttar f�r f�ljande steg i sviten <snippet_keyword>%1%</snippet_keyword>, genererades inte (kontrollera er konfiguration):</snippet_undefined>',
        'failed_scenarios_title' => 'Misslyckade scenarion:',
        'failed_hooks_title'     => 'Misslyckade krokar:',
        'failed_steps_title'     => 'Misslyckade steg:',
        'pending_steps_title'    => 'Avvaktande steg:',
        'scenarios_count'        => '{0} Inga scenarion|{1} 1 scenario|]1,Inf] %1% scenarion',
        'steps_count'            => '{0} Inga steg|[1,Inf] %1% steg',
        'passed_count'           => '[1,Inf] %1% passed',
        'failed_count'           => '{1} 1 misslyckat|]1,Inf] %1% misslyckade',
        'pending_count'          => '[1,Inf] %1% avvaktande',
        'undefined_count'        => '{1} 1 odefinierat|]1,Inf] %1% odefinierade',
        'skipped_count'          => '{1} 1 utel�mnat|]1,Inf] %1% utel�mnade',
    ),
);
